    ...
    <div className="page">
      ...
      <div className="margin-col">
        ...
        <a href="#photography" className="index-item">
          <span className="index-num">02</span>Photography
        </a>
        <a href="#design" className="index-item">
          <span className="index-num">03</span>Design work
        </a>
      ...
      <main>
        <section className="hero" id="introduction">
          ...
          <p className="sub">
            ...
            sits alongside the rest of it — landscape photography and iPhone
            histamatics taken for no client and no brief, kept because they
            were worth keeping.
          </p>
        </section>
        ...
        <section className="section" id="photography">
          ...
          <p className="section-intro">
            Much of this photography seeks out the visual miscellany and
            discarded artefacts most people choose to overlook, walk past, or
            simply step over — usually because they&rsquo;re in a hurry to get
            somewhere more photogenic. The images typically comprise a
            combination of colour, texture and shape, steeped in the passage
            of time and liberally dusted with ephemeral light, a process no
            conservator would thank me for encouraging. This mellow
            &lsquo;ageing&rsquo; gifts the compositions with a life and
            character of their own, resonating still with the lives of the
            people who created, used, neglected and abandoned them — a
            visual testament to transience, life&rsquo;s frailties, and the
            average person&rsquo;s reluctance to throw anything away
            properly.
          </p>
        ...
        <section className="section" id="design">
          ...
          <p className="section-intro">
            ...
            number of which turned out rather well. Some of it has since
            been redesigned by other hands, which is, apparently, what
            happens to good work eventually.
          </p>
      ...
      <footer>
        ...
        <div className="colophon" id="contact">
          <div className="colophon-row">
            ...
            For prints, commissions, or the odd interesting job — get in
            touch.
          </div>
          <div className="colophon-row">
            <span className="cf-label">Contact</span>
            <a href="mailto:keith@keithhodgson.co.uk">
              keith@keithhodgson.co.uk
            </a>
          </div>
          <div className="colophon-row">
            <span className="cf-label">Set in</span>
            EB Garamond &amp; IBM Plex Sans Condensed. Built quietly, Vercel.
          </div>
        </div>
      </footer>
